...
const testimonials = [
  {
    ...
    avatar: "👩‍🦰",
    rating: 5,
    text: "Minha filha não para de cantar a música dela! Chorei de emoção quando vi o vídeo. Presente perfeito de aniversário!",
  },
  {
    name: "Pedro L.",
    ...
    avatar: "👨",
    rating: 5,
    text: "Incrível como a IA conseguiu criar algo tão especial. O Lucas assiste todo dia antes de dormir. Super recomendo!",
  },
  {
    name: "Ana Paula R.",
    ...
    avatar: "👵",
    rating: 5,
    text: "Dei de presente para minha neta e ela amou! A qualidade do vídeo e da música me surpreenderam muito.",
  },
  {
    name: "Carlos M.",
